...
for : FOR '(' expression ';' expression ';' for_incrementation ')' '{' '}'
    | FOR '(' expression ';' expression ';' for_incrementation ')' '{' list '}'
    ;
...
expression: expression '+' expression   { /*$$ = $1 + $3;*/ $$ = new Node(OPERATOR, $1, $3, "+");
                                        cout << "Rezultatul expresiei: " << $$->Eval() << endl;
                                        }
          ...
          | expression EQ expression    { /*$$ = $1 == $3;*/ $$ = new Node(OPERATOR, $1, $3, "==");
                                        cout << "Rezultatul expresiei: " << (($$->Eval() == 1.0) ? "true" : "false") << endl;
                                        }
          ...
          | function_call               {   $$ = $1;
                                            // Typeof_expression += $1;
                                            // Typeof_expression += " ";
                                            cout << "Rezultatul functiei: " << $$->Eval() << endl;
                                        }
